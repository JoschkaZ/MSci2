...
class CGAN():
    ...
    def build_generator(self, noise, con):
        ...
        con1 = Dense(16, activation='tanh')(con)
        ...
        merged_input = Dense(200, activation='tanh')(merged_input)
    ...
    def build_discriminator(self, img, con):
        ...
        #EXPAND LABEL
        con1 = Dense(30, activation='tanh')(con)
        con1 = Dense(100, activation='tanh')(con1)
        ...
        merged_layer = Dense(20, activation='tanh')(merged_layer)
...
if __name__ == '__main__':
    ...
    if args[1] == 'new':
        ...
        cgan.train(epochs=400000, batch_size=8, sample_interval=50, save_model_interval = 2000)
